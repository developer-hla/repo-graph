...
class ApiTests(unittest.TestCase):
    ...
    def test_ui_shell_and_static_assets_are_served(self) -> None:
        ...
        shell = client.get("/ui")
        scripts = {
            "actions": client.get("/ui/assets/actions.js"),
            "api-client": client.get("/ui/assets/api-client.js"),
            "app": client.get("/ui/assets/app.js"),
            "components": client.get("/ui/assets/components.js"),
            "events": client.get("/ui/assets/events.js"),
            "formatters": client.get("/ui/assets/formatters.js"),
            "markup": client.get("/ui/assets/markup.js"),
            "operations-markup": client.get("/ui/assets/operations-markup.js"),
            "relationship-markup": client.get("/ui/assets/relationship-markup.js"),
            "report-markup": client.get("/ui/assets/report-markup.js"),
            "routing": client.get("/ui/assets/routing.js"),
            "views": client.get("/ui/assets/views.js"),
        }
        ...
        script_text = "\n".join(script.text for script in scripts.values())
        self.assertIn("renderOverview", script_text)
        self.assertIn("renderDashboard", script_text)
        self.assertIn("renderExplore", script_text)
        self.assertIn("renderSource", script_text)
        self.assertIn("renderEntity", script_text)
        self.assertIn("renderRelationships", script_text)
        self.assertIn("renderDatabaseReconciliation", script_text)
        self.assertIn("/reports/database-reconciliation", script_text)
        self.assertIn("databaseClassificationGroupsTable", script_text)
        self.assertIn("data-database-code-source", script_text)
        self.assertIn("data-database-source", script_text)
        self.assertIn("impactPathEvidenceTable", script_text)
        self.assertIn("impactStartResultsTable", script_text)
        self.assertIn('data-form="impact-search"', script_text)
        self.assertIn("data-impact-start-type", script_text)
        self.assertIn("data-impact-start-id", script_text)
        self.assertIn("advancedControls", script_text)
        self.assertIn("data-impact-direction", script_text)
        self.assertIn("unresolvedClassificationSections", script_text)
        self.assertIn("unresolvedSourceHotspotsTable", script_text)
        self.assertIn("data-search-query", script_text)
        self.assertIn("coverageWarningsPanel", script_text)
        self.assertIn("data-unresolved-filter", script_text)
        self.assertIn("parseHashRoute", script_text)
        self.assertIn("hydrateRouteState", script_text)
        self.assertIn("writeHashRoute", script_text)
        self.assertIn("hashForRoute", script_text)
        self.assertIn("routeParams", script_text)
        self.assertIn("data-source-name", script_text)
        self.assertIn("data-entity-source-type", script_text)
        self.assertIn("data-relationship-filter", script_text)
        self.assertIn("data-snippet-source", script_text)
        self.assertIn("/relationships/search", script_text)
        self.assertIn("/files/snippet", script_text)
        self.assertIn("/overview", script_text)
        self.assertIn("data-search-type", script_text)
        self.assertIn('data-snapshot-action="status"', script_text)
        self.assertIn("/snapshot/status", script_text)
        self.assertIn('data-job-action="refresh"', script_text)
        self.assertIn('data-job-action="refresh-changed"', script_text)
        self.assertIn("pollJob", script_text)
