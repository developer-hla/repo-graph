...
def python_sql_call_facts(
    ...
    if not raw_sql:
        return []
    return [
        *sql_call_facts(context, raw_sql, call.lineno, from_entity=from_entity),
        *sql_object_read_facts(context, raw_sql, call.lineno, from_entity=from_entity),
        *sql_object_write_facts(context, raw_sql, call.lineno, from_entity=from_entity),
        *sql_object_schema_reference_facts(
            context,
            raw_sql,
            call.lineno,
