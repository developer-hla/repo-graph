...
| `impact` | `CALLS_HTTP`, `CALLS_SERVICE`, `CALLS_SQL`, `CONFIGURES_SERVICE`, `DEPENDS_ON_PACKAGE`, `DEPENDS_ON_PROJECT`, `IMPORTS`, `READS_SQL_OBJECT`, `ROUTES_TO_SERVICE`, `SELECTS_DEPLOYMENT` | Traverse dependency and usage edges for refactor blast-radius analysis. |
